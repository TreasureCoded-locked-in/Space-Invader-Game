...
# Bckground
background = pygame.immage.load('image.png')
...
for _i in range(num_of_enemies):
    enemyImg.append(pygame.image.load('image copy.png'))
...
# Bullet
buletImg = pygame.image.load('image copy 3.png')
bulletX = 0
...
for event in pygame.event.get():
    ...
    for i in range(num_of_enemies):
        ...
        if isCollision(enemyX[i], enemyY[i], bulletX, bulletY):
            ...
            enemyY[i] = random.randint(ENEMY_START_Y_MIN, ENMY_START_Y_MAX)
